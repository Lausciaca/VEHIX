"""
Django settings for vehix project.
...
SECRET_KEY = 'django-insecure-ax!ufpeze_bqs)_m97abnhf!hg0pcshs6c!=jdy#rkzm*&t*r%'
...
WSGI_APPLICATION = 'vehix.wsgi.application'
